...
- Node: blockchain의 복사본을 들고 있는 참여주체이다. 블록체인 네트워크에 연결된 컴퓨터 또는 서버로서, 신규 거래를 검증하고 안전하게 장부에 추가하는 역할을 한다.

블록체인 거래 과정을 좀 더 들여다 보자. 

생성된 블록에 담긴 기록들이 네트워크의 모든 참여 주체들에 의해 검증되면 해당 블록은 닫히고, 블록체인에 추가된다. 이어 새 거래들을 기록하고 검증할 새로운 블록이 생성된다. 블록체인에 새 거래가 나타나면 모든 참여자의 장부에 해당 거래 기록이 추가된다.


  <img src="../../assets/web3/transaction_journey.png">
  <figcaption align="center"><i>resource from Euromoney Learning</i></figcaption>
  <br>
